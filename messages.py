...
class Message:
    ...
    def generate_prompt(self, name, position, company):
        ...
        return f"""Compose a LinkedIn message to {name}, an {position} at {company}, 
                introducing myself as a graduating senior in Computer Science with experience in full-stack Python development. 
                Attached is my resume for your review. I'm interested in learning more about any internship or entry-level job remote 
                positions that are available  {company}, and how my skills can contribute to the company's success. 
    ...
    def message(self, name, position, company):
        ...
        self.response = openai.Completion.create(
            ...
            temperature=uniform(0.20, 0.40),
            max_tokens=randint(100, 250),
        )
